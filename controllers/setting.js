...
// Настройки таймера хода
module.exports.TURN_TIMER_ENABLED = true;
module.exports.TURN_TIMER_DURATION = 30; // секунды на ход
module.exports.TURN_TIMER_WARNING = 10;  // предупреждение за 10 секунд
